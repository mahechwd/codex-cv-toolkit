...
- `$cv-build-bullets` uses a default hard ceiling of 220 visible characters per bullet and aims for a natural block average around 170–180. It must not pad short complete bullets to reach that average.
